...
def main3(battle_music, sound_enabled, name):  # третий уровень
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if menuning:
                    mouse_x, mouse_y = pygame.mouse.get_pos()
                    again.changes(mouse_x, mouse_y, lambda: main3(battle_music, sound_enabled, name), name,
                                  player.point)
